...
| ---------- | ---- | ------ | ------ | ---- |
| currency | false | string | 币种   |  btc, ltc, bch, eth, etc ...(取值参考`/v1/common/currencys`) |
...
--------- | --------- | -------- | ------- | ------ | ------
symbol    | string    | true     | NA      | 交易对 |btcusdt, ethbtc...（取值参考`/v1/common/symbols`）>
...
参数      | 数据类型   | 是否必须  | 默认值   | 描述
--------- | --------- | -------- | ------- | -----------
symbol    | string    | true     | NA      | btcusdt, ethbtc...（取值参考`/v1/common/symbols`）|
...
| ---------- | ---- | ------ | --------------- | ---- | ---- |
| account-id | true | string | account-id，填在 path 中，取值参考 `/v1/account/accounts` |  |      |
...
currency      | false | string | 币种,即btc, ltc, bch, eth, etc ...(取值参考`/v1/common/currencys`)   |       |  |
...
currency|true|	string|币种，即btc, ltc, bch, eth, etc ...(取值参考`/v1/common/currencys`)	|-|
...
| 字段名称       | 是否必需 | 类型     | 字段描述     |取值范围 |
| ---------- | ---- | ------ | ------ | ---- |
| currency | true | string | 币种   |btc, ltc, bch, eth, etc ...(取值参考`/v1/common/currencys`) |
...
| currency | true | string | 资产类型   | btc, ltc, bch, eth, etc ...(取值参考`/v1/common/currencys`) |
| fee     | true | string | 转账手续费  |     |
| chain   | false | string | 取值参考`/v2/reference/currencies`,例如提USDT至OMNI时须设置此参数为"usdt"，提USDT至TRX时须设置此参数为"trc20usdt"，其他币种提现无须设置此参数  |     |
...
---------  | --------- | -------- | ------- | -----------
account-id | string    | true     | NA      | 账户 ID，取值参考 `/v1/account/accounts`。现货交易使用 ‘spot’ 账户的 account-id；逐仓杠杆交易，请使用 ‘margin’ 账户的 account-id；全仓杠杆交易，请使用 ‘super-margin’ 账户的 account-id
symbol     | string    | true     | NA      | 交易对,即btcusdt, ethbtc...（取值参考`/v1/common/symbols`）
...
---------  | --------- | -------- | ------- | -----------
account-id | string    | true    | NA      | 账户 ID，取值参考 `/v1/account/accounts`。现货交易使用‘spot’账户的 account-id；逐仓杠杆交易，请使用 ‘margin’ 账户的 account-id；全仓杠杆交易，请使用 ‘super-margin’ 账户的 account-id
symbol     | string    | ture    | NA      | 交易对,即btcusdt, ethbtc...（取值参考`/v1/common/symbols`）
...
| 参数名称     | 是否必须 | 类型     | 描述           | 默认值  | 取值范围 |
| -------- | ---- | ------ | ------------ | ---- | ---- |
| account-id | true  | string | 账户ID，取值参考 `/v1/account/accounts`     |     |      |
...
| 参数名称   | 是否必须  | 类型     | 描述   | 默认值  | 取值范围   |
| ---------- | ----- | ------ | ------  | ---- | ----  |
| symbol     | true  | string | 交易对      |      |btcusdt, ethbtc...（取值参考`/v1/common/symbols`）  |
...
| 参数名称   | 是否必须  | 类型     | 描述   | 默认值  | 取值范围   |
| ---------- | ----- | ------ | ------  | ---- | ----  |
| symbol     | false  | string | 交易对      |all      |btcusdt, ethbtc...（取值参考`/v1/common/symbols`）  |
...
| 参数名称   | 是否必须  | 类型  | 描述   | 默认值  | 取值范围    |
| ---------- | ----- | ------ | ------ | ---- | ----------- |
| symbol     | true  | string | 交易对   | NA |  btcusdt, ethbtc...（取值参考`/v1/common/symbols`）|
...
参数       | 数据类型 | 是否必须 | 默认值 | 描述 | 取值范围
--------- | --------- | -------- | ------- | ------ | ------
symbols    | string    | true     | NA      | 交易对，可多填，逗号分隔 |btcusdt, ethbtc...（取值参考`/v1/common/symbols`）>
...
--------- | --------- | -------- | -----------                      | -----------
symbol    | string    | true     | 交易代码     | btcusdt, ethbtc...（取值参考`/v1/common/symbols`）
...
参数 | 数据类型 | 是否必需 | 缺省值         | 描述                                       | 取值范围
--------- | --------- | -------- | -------------         | -----------                                       | -----------
symbol    | string    | true     | NA                    | 交易代码                   | btcusdt, ethbtc...（取值参考`/v1/common/symbols`）
...
参数 | 数据类型 | 是否必需 | 缺省值         | 描述                                    | 取值范围
--------- | --------- | -------- | -------------         | -----------                                       | -----------
symbol    | string    | true     | NA                    | 交易代码                       | btcusdt, ethbtc...（取值参考`/v1/common/symbols`）, 支持通配符"*".
...
参数 | 数据类型 | 是否必需 | 缺省值         | 描述                                       | 取值范围
--------- | --------- | -------- | -------------         | -----------                                       | -----------
symbol    | string    | true     | NA                    | btcusdt, ethbtc...（取值参考`/v1/common/symbols`）, 支持通配符"*".
